...
def get_compiled_pipeline():
    ...
    workflow.add_node("create_fb_post", generate_fb_node(model="groq/llama-3.3-70b-versatile"))
    ...
    workflow.add_edge("create_announcing_script","create_fb_post")
    workflow.add_edge("create_fb_post","create_media")
